...
public class RightHandMazeSolverTest {
    ...
    private final char[][] validMaze = new char[][] {
        {'#', '#', '#', '#', '#', '#', '#'},
        {'#', '#', '#', ' ', ' ', ' ', '#'},
        {'#', '#', '#', ' ', '#', ' ', '#'},
        {' ', ' ', ' ', ' ', '#', ' ', ' '},
    ...
    public void testValidateCorrectPath() {
        ...
        path = path.replace(" ", "");
        assertTrue(solver.validatePath(validMaze, entry, exit, path));
    }
    ...
    public void testValidatePathThroughWalls() {
        ...
        path = path.replace(" ", "");
        assertFalse(solver.validatePath(validMaze, entry, exit, path));
    }
    ...
    public void testFindAnyPathNotEmpty() {
        List<Character> path = solver.findAnyPath(validMaze, entry, exit);
    ...
    public void testFindAnyPathIsValid() {
        ...
        assertTrue(solver.validatePath(validMaze, entry, exit, canonical));
    }
